...
<head>
  ...
  <title>JDAM Portfolio - Projects</title>
  <link rel="icon" href="assets/moreImgs/rowletticn.png" type="image/png">
</head>
<body>
  ...
  <section id="info" class="py-5">
    <div class="container text-center">
      ...
      <p>Feel free to scan and look at my projects, they will be updated regularly so please look forward to it!</p>
    </div>
  </section>

  <section id="projects" class="py-5">
    <div class="container">
      <h2 class="text-center text-white mb-5">Finished Projects:</h2>
      <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
        
        <div class="col">
          <div class="card bg-dark text-white">
            <div class="card-img-overlay d-flex align-items-center justify-content-center">
              <a href="A08/index.php" class="btn btn-outline-light">Inside Joseph's Mind</a>
            </div>
          </div>
        </div>
